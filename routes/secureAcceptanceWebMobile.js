...
router.get('/', (req, res) => {
    ...
    const accessKey = process.env.SECURE_ACCEPTANCE_ACCESS_KEY;
    const profileId = process.env.SECURE_ACCEPTANCE_PROFILE_ID;
...
router.post('/confirmation', (req, res) => {
    ...
    const SECRET_KEY = process.env.SECURE_ACCEPTANCE_SECRET_KEY;
